<input type="hidden" name="settings[field_template]" value="textarea">
...
<div class="form-group">
    <label for="rows">Rows <span class="text-danger">*</span></label>
    <input type="number" min="1" name="settings[rows]" class="form-control" value="{{ old('settings.rows', $custom_field->settings['rows'] ?? 3) }}" required>
</div>
