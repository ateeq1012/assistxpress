                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 pr-0"> <div class="alert alert-info mr-3">Keep service windows options empty for 24 hrs.</div> </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 pr-0">
                                                        <div class="alert alert-info mr-3">Keep statuses empty to apply all statuses.</div>
                                                        <div class="form-group  mr-3<?php echo ($errors->has('sla_statuses')) ? 'has-error' : ''; ?>">
