...
<style>
	...
	#main_content_div {
		margin: -1px -12px 0px -20px !important;
		height: calc(100vh - 100px);
	}
...
<div id="main_content_div" class="wrapper wrapper-content animated fadeIn pt-1">
	<div class="ibox-content m-0 p-0" style="background-color:#f3f3f4;">
		...
		<div class="row">
			<div class="col-3 pr-1">
				<div class="ibox">
					...
					<div id="map-configs" class="ibox-content p-1">
			...
			<div class="col-9 pl-1 pr-2">
				<div class="row">
					<div id="data-col" class="col-0">
					</div>
					<div id="map-col" class="col-12">
						<div id="map" class="big-map"></div>
						<div id="bar-chart" style="width:500px; height:0px;"></div>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	$("#integration_ems").change(function() {
		...
		if( val != "" )
		{
			$('#main_content_div').children('.ibox-content').addClass('sk-loading');
			...
			{
				$('#main_content_div').children('.ibox-content').removeClass('sk-loading');
	...
	function splitLayout() {
		...
		$('#bar-chart').css('height', 'calc(100vh - 700px)'); // Adjust the height as needed
	...
	function defaultLayout() {
		...
		$('#bar-chart').css('height', '0px'); // Adjust the height as needed
